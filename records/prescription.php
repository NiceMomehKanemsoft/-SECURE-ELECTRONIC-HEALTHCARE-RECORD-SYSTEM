...
$stmt = $pdo->query(
    "SELECT r.id, r.key_id, r.created_at, p.first_name, p.last_name, u.username as creator
     ...
     WHERE r.record_type='Prescription' ORDER BY r.created_at DESC LIMIT 100"
);
...
<main class="main-content">
    <div class="page-header">
        ...
        <a href="<?= BASE_URL ?>/records/create.php" class="btn btn-primary btn-sm">+ New Prescription</a>
        <?php endif; ?>
    </div>
    <div class="card">
        <div class="table-wrap">
            <table>
                <thead><tr><th>Patient</th><th>Prescribed By</th><th>Date</th><th>Encryption</th><th>Action</th></tr></thead>
                <tbody>
                <?php if (empty($records)): ?>
                <tr><td colspan="5" class="text-center text-muted" style="padding:32px;">No prescriptions found.</td></tr>
